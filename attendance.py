...
class Attendance:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"1628243597666college-images\college_images\smart-attendance.jpg")
        img=img.resize((800,200),Image.LANCZOS)
        self.photoimage=ImageTk.PhotoImage(img)
        f_lbl=Label(self.root,image=self.photoimage)
        f_lbl.place(x=0,y=0,width=680,height=150)

        # second image
        img1=Image.open(r"1628243597666college-images\college_images\iStock-182059956_18390_t12.jpg")
        img1=img1.resize((800,200),Image.LANCZOS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        f_lbl=Label(self.root,image=self.photoimage1)
        f_lbl.place(x=680,y=0,width=680,height=150)
        ...
        bg_img.place(x=0,y=150,width=1350,height=710)
        ...
        left_frame.place(x=10,y=5,width=650,height=495)
        img_left=Image.open(r"1628243597666college-images\college_images\face-recognition.png")
        img_left=img_left.resize((640,125),Image.LANCZOS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)
        f_lbl=Label(left_frame,image=self.photoimg_left)
        f_lbl.place(x=5,y=0,width=640,height=125)
        left_inside_frame=Frame(left_frame,bd=2,relief=RIDGE,bg="white")
        left_inside_frame.place(x=0,y=130,width=645,height=340)
        ...
        btn_frame.place(x=5,y=290,width=625,height=40)
        # save button
