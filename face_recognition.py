...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="FACE RECOGNITION",font=("times new roman",30,"bold"),bg="light yellow",fg="dark green")
        ...
        img_top=img_top.resize((550,660))
        self.photoimg_top=ImageTk.PhotoImage(img_top)
        f_lbl=Label(self.root,image=self.photoimg_top)
        f_lbl.place(x=0,y=35,width=550,height=660)
        ...
        img_bottom=img_bottom.resize((850,660))
        self.photoimg_bottom=ImageTk.PhotoImage(img_bottom)
        f_lbl=Label(self.root,image=self.photoimg_bottom)
        f_lbl.place(x=550,y=35,width=850,height=660)
        ...
        b1_1.place(x=320,y=580,width=200,height=40)
        ...
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                if confidence>77:
                    ...
                    cv2.putText(img,"Unknowm Face",(x,y-5),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),2)
                coord=[x,y,w,y]
            return coord
